...
angular.module('Cloobster.services').factory('cloobsterResource',['$resource','config', 'errorHandler', function($resource, config, handleError) {
	...
	function ResourceFactory(url, paramDefaults, actions) {
		...
		/**
		* @name Cloobster.services.cloobsterResource#$create
