...
/** 
* @constructor
* Handles calls to the Facebook JavaScript SDK and listens to status change
* events from the Facebook SDK.
* 
* @author Nils Weiher
*/
Cloobster.services.
factory('facebookApi', ['$q','$rootScope', function($q, $rootScope) {
	...
	fbApiService = {
		...
		* Used for further Api calls and authorization with
		* Cloobster.
		*
		...
		* @returns {Object} promise object which can be resolved to user in the future.
		*/
		getUser : function () {
			// Create a deffered object to resolve/reject in the future
